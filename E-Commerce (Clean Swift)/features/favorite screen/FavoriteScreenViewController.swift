...
class FavoriteScreenViewController: UIViewController, FavoriteScreenDisplayLogic
{
  var interactor: FavoriteScreenBusinessLogic?
  var router: (NSObjectProtocol & FavoriteScreenRoutingLogic & FavoriteScreenDataPassing)?
  ...
  func doSomething()
  {
    let request = FavoriteScreen.Something.Request()
